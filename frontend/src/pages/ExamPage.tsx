  ...
  useEffect(() => {
    const fetchExamDetails = async () => {
      try {
        ...
        response.data.studentExamDetails.exam.questions.forEach(
          (q: Question) => {
  ...
  return smowlUrl ? (
    <>
      <h5 className="text-muted mt-3">
        <span className="text-danger">Important:</span> Do not close the "SMOWL CM" application while taking the
        exam, as doing so may result in your exam restarting.
      </h5>
